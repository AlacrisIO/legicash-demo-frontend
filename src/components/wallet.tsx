    ...
    public render() {
        ...
        <Segment>
            ...
            <Segment vertical={true} style={{margin: 0, padding: 0}}>
                ...
                <OffchainBalance balance={this.props.wallet.offchainBalance}  pending={this.hasActionsPending()} />
            ...
            <Accordion exclusive={false} fluid={true} >
                ...
                />
                    <Accordion.Content active={this.isOpen('deposit')}>
                        <DepositDialog from={this.props.wallet.address} loading={this.props.pendingStates.deposit} submitCallback={this.makeDeposit} />
                    </Accordion.Content>
                </Segment>
                ...
                <Segment vertical={true}>
                    ...
                    <Accordion.Content active={this.isOpen('withdraw')}>
                        <WithdrawDialog from={this.props.wallet.address} loading={this.props.pendingStates.withdrawal} submitCallback={this.makeWithdrawal} />        
                    </Accordion.Content>
                </Segment>
                ...
                <Segment vertical={true}>
                    ...
                    <Accordion.Content active={this.isOpen('pay')}>
                        <PayDialog from={this.props.wallet.address} loading={this.props.pendingStates.payment} submitCallback={this.makePayment} />
                    </Accordion.Content>
                </Segment>
