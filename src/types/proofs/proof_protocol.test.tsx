import { IResponse, IBranch, step } from '../proofs/proof_types'
...
const branch_steps: IBranch[] =
    hashes.map(h => ({ 'right': h, 'type': 'Left' }))
const steps: step[] = [
    { 'bits': '0x1', 'length': 1, 'type': 'Skip' }, ...branch_steps]
...
const example_proof: IResponse = { 'key': '0x1', leaf, trie, steps }
...
describe('Merkle proof tests', () => {
    it('It validates a valid proof', () =>
        ...
        // expect(responseWellFormed(example_proof).message).toBeUndefined()
